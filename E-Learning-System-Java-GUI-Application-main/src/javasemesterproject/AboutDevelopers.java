...
public class AboutDevelopers extends JFrame{
    ...
    public AboutDevelopers() {
        ...
        String[][] rowData = {{"harsha vardhan","kalyani" "<html>Modules Development<html>"},
                               {"tilak", "sindhu", "<html>Modules Integration<br/> and Code Refinement</html>"},
                               {"sirisha", "shivani", "<html>Database Connectity<br/> and Design</html>"}};
        String columns[] = {"name1", "Name2", "Contributions"};
